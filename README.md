# PlantPulse-AI
an AI-powered monitoring system for early detection and smart treatment of plant diseases


🚀 Overview
A deep learning-based application that detects plant leaf diseases from images and provides basic treatment suggestions using a CNN model.
...
📂 Project Structure
app.py model.keras requirements.txt .python-version
